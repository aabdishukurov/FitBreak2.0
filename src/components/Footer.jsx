...
const Footer = () => {
  const links = [
    ...
    { id: "2", link: "/main", title: "О приложении" },
    { id: "3", link: "/main", title: "FitBreakPRO" },
    { id: "4", link: "/main", title: "категории" },
    { id: "5", link: "/main", title: "контакты" },
    { id: "5", link: "/main", title: "Вы - нутрициолог?" },
  ];

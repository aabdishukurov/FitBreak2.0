...
export const ProfileUser = () => {
  ...
  const [avatarUrl, setAvatarUrl] = useState(Cookies.get("avatar") || Avatar);
  ...
  const handleImageChange = (e) => {
    ...
    reader.onloadend = () => {
      ...
      Cookies.set("avatar", newAvatarUrl); // Сохраняем ссылку на изображение в Cookies
    };
  ...
  //     Cookies.remove("avatar"); // Удаляем Cookies при размонтировании компонента
  //   };
  // }, []);
    ...
    <div className="container">
      <div className={styles.profile__user}>
        <div className={styles.profile__user__right_side}>
          <img width={"190px"} src={avatarUrl} alt="avatar" />

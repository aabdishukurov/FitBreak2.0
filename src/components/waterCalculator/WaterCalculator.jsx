  ...
  return (
    <div className="waterComponent">
      ...
      <div className="aboutCalc">
        <p>
          Норма воды - это то количество воды, которое желательно выпивать
          помимо чая, кофе, соков и других напитков. Расчитайте свою норму, с
          помощью нашего <strong>калькулятора.</strong>{" "}
        </p>
      </div>
      ...
      <div className="water_info">
        <p>
          Данный расчет носит рекомендательный характер. Для того, чтобы
          получить более точную информацию <br />
          необходимо обратиться к диетологу.
          <br />
          <br />
          Для расчета используются рекомендации различных стран и ВОЗ,

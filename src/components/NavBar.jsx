...
const links = [
  ...
  { id: "3", link: "/categories", title: "Упражнения" },
  { id: "4", link: "/", title: "FitBreak" },
];
...
const NavBar = () => {
  ...
  let profile = proStatus ? (
    ...
    <>
      <Link className="nav__btn_signin" to={"/login"}>
        Войти
      </Link>
      <Link className="nav__btn_signup" to={"register"}>
        Присоединиться
      </Link>
    </>
  );
      ...
      <div className="nav__top">
        ...
        <div className="nav__top__helpers">
          ...
          <div className="nav__top__helpers__lang">
            <select className="nav__btns-lang" name="" id="">
